...
import 'package:kpkwk/logic/routing.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // home:
      //     //CureDetails(pred: "Acne / Rosacea", cure: llmanswers["Herpes HPV"]!)
      //     CurePage(
      //   cure1: llmanswers["Acne / Rosacea"]!,
      //   pred1: "Acne / Rosacea",
      //   pred2: "Exanthems (Drug Eruptions)",
      //   pred3: "Vasculitis",
      //   cure3: llmanswers["Vasculitis"]!,
      //   cure2: llmanswers["Exanthems (Drug Eruptions)"]!,
      // )
